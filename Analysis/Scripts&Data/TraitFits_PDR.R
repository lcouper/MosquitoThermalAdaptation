...
PDRdf_uni$Population = factor(PDRdf_uni$Population, levels = LatOrder)
...
plotPDRuni = ggplot(PDRdf_uni, aes(x=Population, y=mean, col = LatColors)) + 
...
plot(PupalDevRate ~ Temp.Treatment, 
     xlim = c(5, 40), ylim = c(0,0.3), data = data.PDR.HOP, type = "n", bty = "n",
     ylab = "rate (1/day)", xlab = "Temperature (\u00B0C)", pch = 1,
     main = "Pupal development rates", cex.main = 1.7, cex.lab = 1.4, cex.axis = 1.2)
box(col = "black")
lines(EUGdata ~ Temp.xs, col = "#313695", lwd = 1.5)
