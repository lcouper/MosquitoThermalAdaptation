...
pPSdf_uni$Population = factor(pPSdf_uni$Population, levels = LatOrder)
...
plotpPSuni = ggplot(pPSdf_uni, aes(x=Population, y=mean, col = LatColors)) + 
...
plot(Pupal.Survival ~ Temp.Treatment, 
     ...
     main = "Probability pupal survival", cex.main = 1.7, cex.lab = 1.4, cex.axis = 1.2)
box(col = "black")
lines(EUGdata ~ Temp.xs, col = "#313695", lwd = 1.5)
